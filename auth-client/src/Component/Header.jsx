      ...
      <div className="container mx-auto py-[14vh]">
        <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">
          <div className="lg:w-[32rem] w-full flex flex-col space-y-6 ">
            ...
            <div className="lg:text-xl text-[#191919] md:text-xl text-base ">
              Labore pariatur laborum nostrud sunt. Elit minim dolor proident
              esse sint laborum esse nostrud minim. Magna ipsum amet ea ullamco
              labore. Do exercitation sunt nostrud magna nulla do commodo
              ullamco minim officia sunt amet.
            </div>
            ...
            <div className="flex rounded-full py-2 px-4 justify-between items-center bg-white shadow-md">
              ...
              <div className="h-10 w-10 relative bg-[#fdc55e] rounded-full">
                <FaSearch
                  size={15}
                  className="cursor-pointer text-white absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
                />
              </div>
            </div>
            <div className="flex  gap-8 items-center">
              ...
              <div className="sm:flex hidden gap-4 items-center">
                <div className="h-14 w-14 shadow-md cursor-pointer relative bg-white rounded-full">
                  <FaPlay
                    size={18}
                    className="cursor-pointer text-[#f54748] absolute top-1/3 left-1/2 -translate-x-1/2 -transslate-y-1/2 "
                  />
                </div>
