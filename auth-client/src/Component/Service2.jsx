        ...
        <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">
          <div className="w-full md:w-[32rem] flex flex-col space-y-6  ">
            ...
            <div className="lg:text-lg text-[#191919] md:text-base text-sm">
              Magna consectetur ex cillum do laborum exercitation elit amet
              adipisicing cupidatat. Ullamco nisi et laborum sunt in. Aute
              aliqua quis eu magna ex eiusmod mollit exercitation commodo tempor
              proident veniam tempor aliqua.
            </div>
